...
public class TrappingRainWater128X16 {
  ...
  static void computePrefixMax(
    ...
    for (int i = 0; i < iterations; i++) {
      ...
      _part0 = _t0.rearrange(_zip0, _part4);
      _part1 = _t0.rearrange(_zip1, _part4);

      _part4 = _t1.rearrange(_zip0, _part5);
      _part5 = _t1.rearrange(_zip1, _part5);

      _part2 = _t4.rearrange(_zip0, _partC);
      _part3 = _t4.rearrange(_zip1, _partC);

      _part8 = _t2.rearrange(_zip0, _part6);
      _part9 = _t2.rearrange(_zip1, _part6);

      _part6 = _t5.rearrange(_zip0, _partD);
      _part7 = _t5.rearrange(_zip1, _partD);

      _partC = _t3.rearrange(_zip0, _t8);
      _partD = _t3.rearrange(_zip1, _t8);

      _partA = _t6.rearrange(_zip0, _partE);
      _partB = _t6.rearrange(_zip1, _partE);

      _partE = _t7.rearrange(_zip0, _partF);
      _partF = _t7.rearrange(_zip1, _partF);


      _part0.intoArray(pivotedInput, pos + 0 * vl);
      _part1.intoArray(pivotedInput, pos + 1 * vl);
      ...
      var _partZ = _prev.slice(3, _partF);

      var _shifted = _zero.slice(3, _partZ);
      _partZ = _partZ.max(_shifted);

      _shifted = _zero.slice(2, _partZ);
      _partZ = _partZ.max(_shifted);
  ...
  static int computeSuffixMaxFused(
    ...
    int trapped = 0, acc = 0, pos = pivotedInput.length;
    while (remainder-- > 0) {
    ...
    for (int i = 0; i < iterations; i++) {
      ...
      int[] pi = pivotedInput;
      var _part0 = IntVector.fromArray(SP, pi, pos + 0 * vl);
      var _part1 = IntVector.fromArray(SP, pi, pos + 1 * vl);
      ...
      var _shifted = _partZ.slice(1, _zero);
      _partZ = _partZ.max(_shifted);

      _shifted = _partZ.slice(2, _zero);
      _partZ = _partZ.max(_shifted);
      ...
      var _pf1 = IntVector.fromArray(SP, prefixMax, pos + 1 * vl);
      ...
      var _pv0 = IntVector.fromArray(SP, pivotedInput, pos);
      var _pv1 = IntVector.fromArray(SP, pivotedInput, pos + 1 * vl);
      var _pv2 = IntVector.fromArray(SP, pivotedInput, pos + 2 * vl);
      var _pv3 = IntVector.fromArray(SP, pivotedInput, pos + 3 * vl);
      var _pv4 = IntVector.fromArray(SP, pivotedInput, pos + 4 * vl);
      var _pv5 = IntVector.fromArray(SP, pivotedInput, pos + 5 * vl);
      var _pv6 = IntVector.fromArray(SP, pivotedInput, pos + 6 * vl);
      var _pv7 = IntVector.fromArray(SP, pivotedInput, pos + 7 * vl);
      var _pv8 = IntVector.fromArray(SP, pivotedInput, pos + 8 * vl);
      var _pv9 = IntVector.fromArray(SP, pivotedInput, pos + 9 * vl);
      var _pvA = IntVector.fromArray(SP, pivotedInput, pos + 10 * vl);
      var _pvB = IntVector.fromArray(SP, pivotedInput, pos + 11 * vl);
      var _pvC = IntVector.fromArray(SP, pivotedInput, pos + 12 * vl);
      var _pvD = IntVector.fromArray(SP, pivotedInput, pos + 13 * vl);
      var _pvE = IntVector.fromArray(SP, pivotedInput, pos + 14 * vl);
      var _pvF = IntVector.fromArray(SP, pivotedInput, pos + 15 * vl);
