...
public class MaximumSubarray128X8 {
  ...
  static public int compute(int[] input) {
    ...
    for (int i = 0; i < longIterations; i++) {
      ...
      var _t0 = _sum0;
      _sum0 = _sum0.rearrange(_zip0, _sum4);
      _sum4 = _t0.rearrange(_zip1, _sum4);
      var _t1 = _sum1;
      _sum1 = _sum1.rearrange(_zip0, _sum5);
      _sum5 = _t1.rearrange(_zip1, _sum5);
      var _t2 = _sum2;
      _sum2 = _sum2.rearrange(_zip0, _sum6);
      _sum6 = _t2.rearrange(_zip1, _sum6);
      var _t3 = _sum3;
      _sum3 = _sum3.rearrange(_zip0, _sum7);
      _sum7 = _t3.rearrange(_zip1, _sum7);
      ...
      _sum0 = _t0.rearrange(_zip0, _sum2);
      _sum1 = _t0.rearrange(_zip1, _sum2);

      _sum4 = _t1.rearrange(_zip0, _sum3);
      _sum5 = _t1.rearrange(_zip1, _sum3);

      _sum2 = _t2.rearrange(_zip0, _sum6);
      _sum3 = _t2.rearrange(_zip1, _sum6);

      _sum6 = _t3.rearrange(_zip0, _sum7);
      _sum7 = _t3.rearrange(_zip1, _sum7);
      ...
      var _sumZ = _prev_sum.slice(3, _sum7);

      var _shifted = _zero.slice(3, _sumZ);
      _sumZ = _sumZ.add(_shifted);

      _shifted = _zero.slice(2, _sumZ);
      _sumZ = _sumZ.add(_shifted);
      ...
      var _min2 = _sum1;
      var _min1 = _sum0;
      var _min0 = _prev_sum.slice(3, _sum7);
      ...
      var _minZ = _prev_min.slice(3, _min7);

      _shifted = _top.slice(3, _minZ);
      _minZ = _minZ.min(_shifted);

      _shifted = _top.slice(2, _minZ);
      _minZ = _minZ.min(_shifted);
